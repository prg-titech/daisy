...
function make_step1c() {
    ...
    if(workspace.getBlocksByType("data_definition", false).length > 0){
        document.getElementById("step1c").innerHTML = `
            <label text="Data Example" web-class="header-font"></label>
            <sep gap="10"></sep>
            <button text="Check" callbackKey="checkStep1c"></button>

            <label text="Data Example's Name"></label>
            <sep gap="0"></sep>
            <block type="data_example"></block>
            
            <label text="Argument Value"></label>
            <sep gap="0"></sep>
            <block type="arg_value"></block>
            
            <label text="Data Example Templates"></label>
            <sep gap="0"></sep>
        ` + data_ex;
